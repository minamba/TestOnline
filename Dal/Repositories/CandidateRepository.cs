...
namespace Dal.Repositories
{
    public class CandidateRepository : ICandidatesRepository
    {
        ...
        {
            var candidateResults = await _MyContext.Result.Include("Answer").ToListAsync();
            var resultModel = candidateResults.Select(r => new ResultModel(r.Candidate.FirstName, r.Candidate.LastName, r.AnswerId,r.Answer.IsGood)).ToList();
